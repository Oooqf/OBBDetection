...
from .obb.obb_two_stage_multi import OBBTwoStageDetectorMulti
from .obb.oriented_rcnn_multi import OrientedRCNNMulti
__all__ = [
    ...
    'FasterRCNNOBB', 'RetinaNetOBB', 'RoITransformer','OBBTwoStageDetectorMulti','OrientedRCNNMulti'
]
