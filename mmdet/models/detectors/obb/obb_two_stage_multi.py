...
class OBBTwoStageDetectorMulti(OBBBaseDetector, RotateAugRPNTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(OBBTwoStageDetectorMulti, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(OBBTwoStageDetectorMulti, self).init_weights(pretrained)
