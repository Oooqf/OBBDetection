...
class AlienateBoxHead(OBBoxHead):
    ...
    def __init__(self,
                 ...
                 parallel_num = 2,
                 peak_supress_cfg = None,
                 rand_supress_cfg = None,
    ...
    def loss(self, cls_score, bbox_pred, rois, labels, label_weights, bbox_targets, bbox_weights, cls_feats, ps_score, rs_score, ious, reduction_override=None,**kwargs):
