...
class OBBoxHead(nn.Module):
    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            losses['neg_num'] = neg_inds.sum().float()
            if pos_inds.any():
                losses['pos_acc'] = correct_num(cls_score[pos_inds], labels[pos_inds]) / losses['pos_num'] * 100.0
            if neg_inds.any():
                losses['neg_acc'] = correct_num(cls_score[neg_inds], labels[neg_inds]) / losses['neg_num'] * 100.0
