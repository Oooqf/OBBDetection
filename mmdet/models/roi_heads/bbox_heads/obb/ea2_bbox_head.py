...
class EA2BBoxHead(OBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(EA2BBoxHead, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(EA2BBoxHead, self).init_weights()
...
@HEADS.register_module()
class FineGrainedEA2BBoxHead(EA2BBoxHead):
    def __init__(self, *args, **kwargs):
        super(FineGrainedEA2BBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=0,
            num_cls_convs=0,
            num_cls_fcs=2,
