...
class CALFCBBoxHead2(OBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(CALFCBBoxHead2, self).__init__(*args, **kwargs)
        ...
        self.shared_convs, self.shared_fcs, last_layer_dim = \
            self._add_conv_fc_branch(
                self.num_shared_convs, self.num_shared_fcs, last_channels*2)
    ...
    def init_weights(self):
        super(CALFCBBoxHead2, self).init_weights()
...
@HEADS.register_module()
class CALShared2FCBBoxHead2(CALFCBBoxHead2):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(CALShared2FCBBoxHead2, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
