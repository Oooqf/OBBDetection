...
dataset_classes = {
    ...
    'DIOR': ('airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge',
             ...
             'windmill'),
    'FAIR1M':('A220', 'A321', 'A330', 'A350', 'ARJ21', 'Boeing737', 'Boeing747', 'Boeing777', 
    'Boeing787', 'C919', 'other-airplane', 'Cargo_Truck', 'Dry_Cargo_Ship', 'Engineering_Ship',
     'Fishing_Boat', 'Liquid_Cargo_Ship', 'Motorboat', 'Passenger_Ship', 'Tugboat', 'Warship',
      'other-ship', 'Bus', 'Dump_Truck', 'Excavator', 'Small_Car', 'Tractor', 'Trailer', 
      'Truck_Tractor', 'Van', 'other-vehicle', 'Baseball_Field', 'Basketball_Court', 'Football_Field',
       'Tennis_Court', 'Bridge', 'Intersection', 'Roundabout'),
    'SARAR':('A220', 'A320/321', 'ARJ21', 'A330', 'Boeing737-800', 'Boeing787', 'other'),
    'HRSC': ('ship', ),
    'MSRA_TD500': ('text', ),
}
...
dataset_aliases = {
    ...
    'FAIR1M':product(['fair1m','FAIR1M'],['']),
    'SARAR':product(['sarar','SARAR'],['']),
