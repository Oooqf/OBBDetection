...
data_root = '/root/oqf/Data/FAIR1M_1024-200-1/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        # ann_file=data_root + 'train/annfiles/',
        # img_prefix=data_root + 'train/images/',
        ann_file=data_root + 'train_1024_500_1.0/labelTxt/',
        img_prefix=data_root + 'train_1024_500_1/images/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'test_1024_500_1.0/labelTxt/',
        img_prefix=data_root + 'test_1024_500_1/images/',
        pipeline=test_pipeline))
# evaluation = dict(metric='mAP')
