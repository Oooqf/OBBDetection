...
CATEGORIES = (
    ...
    ('Ship',(
         'Cargo Truck', 'Dry Cargo Ship', 'Engineering Ship','Fishing Boat', 'Liquid Cargo Ship',
          'Motorboat', 'Passenger Ship', 'Tugboat', 'Warship','other-ship')
    ),
    ('Vehicle',(
        'Bus', 'Dump Truck', 'Excavator', 'Small Car', 'Tractor', 
        'Trailer', 'Truck Tractor','Van', 'other-vehicle',
        )
    ),
    ('Court',(
    ...
    ,
    ('Road',(
        'Bridge', 'Intersection', 'Roundabout',)
    ),
)
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[
            ...
            data_root+'/trainval/annfiles/',
        ],
        img_prefix=[
            # data_root+'/train/images/',
            # data_root+'/val/images/',
            data_root+'/trainval/images/',
        ],
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='OBBMultiBBoxHead',
            categories=CATEGORIES,
            start_bbox_type='obb',
            end_bbox_type='obb',
            num_sub_shared_fcs=1,
