...
data = dict(
    ...
    train=dict(
        type='FAIR1MDataset',
        task='Task1',
        ann_file='/root/datasets/split_ms_fair1m/trainval/annfiles/',
        img_prefix='/root/datasets/split_ms_fair1m/trainval/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadOBBAnnotations',
...
log_level = 'INFO'
load_from = None
resume_from = r'/root/code/OBBDetection/work_dirs/faster_rcnn_orpn_r50_fpn_1x_fair1m_ea2/epoch_5.pth'
workflow = [('train', 1)]
model = dict(
    type='OrientedRCNN',
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            ...
            roi_layer=dict(type='RoIAlignRotated', out_size=16, sample_num=2),
            out_channels=256,
...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        max_per_img=2000))
work_dir = './work_dirs/faster_rcnn_orpn_r50_fpn_1x_fair1m_ea2'
gpu_ids = range(0, 1)
